...
def detour_with_road_map(
        region_data_file='../Data/AUE-200/Datacenter.shp',
        barrier_data_file='../Data/AUE-200/地理障碍合并.shp',
        road_map_file='../Data/AUE-200/AUE路网匹配.shp',
        id_name='areaID',
...
if __name__ == '__main__':
    ...
    road_data_file = '../Data/AUE-200/road_map.shp'
    id_name = 'areaID'
    save_path = '../result/detour/AUE-200-r10km'
    detour_with_road_map(region_data_file, barrier_data_file, road_data_file,
                         id_name, 0.5, 10, save_path, use_osmnx=False, st_id=1)
    convert_text_to_csv(save_path, id_name, '../AUE-200-r10km detour ')
    save_path = '../result/detour/AUE-200-r5km'
    detour_with_road_map(region_data_file, barrier_data_file, road_data_file,
                         id_name, 0.25, 5, save_path, use_osmnx=False, st_id=1)
    convert_text_to_csv(save_path, id_name, '../AUE-200-r5km detour ')

    # GUB
    id_name = 'GUB_ID'
    region_data_file = "../Data/GUB/GUB_center.shp"
    barrier_data_file = "../Data/GUB/GUB_barrier.shp"
    road_data_file = "../Data/GHUB/GHUB road_map.shp"
    save_path = '../result/detour/GUB-r10km'
    detour_with_road_map(region_data_file, barrier_data_file, road_data_file,
                         id_name, 0.5, 10, save_path)
    convert_text_to_csv(save_path, id_name, '../GUB-r10km detour ')
    save_path = '../result/detour/GUB-r5km'
    detour_with_road_map(region_data_file, barrier_data_file, road_data_file,
                         id_name, 0.25, 5, save_path)
    convert_text_to_csv(save_path, id_name, '../GUB-r5km detour ')

    # GHUB
    id_name = 'GHUB_ID'
    region_data_file = "../Data/GHUB/GHUB_center.shp"
    barrier_data_file = "../Data/GHUB/GHUB_barrier.shp"
    road_data_file = "../Data/GHUB/GHUB road_map.shp"
    save_path = '../result/detour/GHUB-r10km'
    detour_with_road_map(region_data_file, barrier_data_file, road_data_file,
                         id_name, 0.5, 10, save_path, )
    convert_text_to_csv(save_path, id_name, 'GHUB-r10km detour ')
    save_path = '../result/detour/GHUB-r5km'
    detour_with_road_map(region_data_file, barrier_data_file, road_data_file,
                         id_name, 0.25, 5, save_path, )
    convert_text_to_csv(save_path, id_name, 'GHUB-r5km detour ')
