...
if __name__ == '__main__':
    # AUE
    region_data_file = "Data/AUE-200/inculude country bound/Data地理障碍10km包含国界的城市（3个）_中心点.shp"
    barrier_data_file = "Data/AUE-200/inculude country bound/Data地理障碍10km包含国界的城市（3个）.shp"
    id_name = 'areaID'
